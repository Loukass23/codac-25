                                    ...
                                    <TreeItemLabel
                                        onClick={() => {
                                            ...
                                            if (isFolder) {
                                                ...
                                                router.push(`/docs?preview=${itemId}`);
                                            }
                                        }}
                                    >
                                        <div className='flex items-center gap-2 w-full group'>
                                            ...
                                            {isFolder && itemData.documentCount !== undefined && itemData.documentCount > 0 && (
                                                        ...
                                                        <>
                                                            ...
                                                            <DropdownMenuItem
                                                                onClick={() => {
                                                                    ...
                                                                    router.push(`/docs/new?${params.toString()}`);
                                                                }}
                                                            >
                                                        ...
                                                        <>
                                                            <DropdownMenuItem
                                                                onClick={() => {
                                                                    ...
                                                                    router.push(`/docs?preview=${item.getId()}`);
                                                                }}
                                                            >
                                                                Open
                                                            </DropdownMenuItem>
